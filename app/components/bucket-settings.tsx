          ...
          {buckets.map((bucket) => {
            ...
            return (
              ...
              >
                ...
                <textarea
                  className="mt-4 min-h-24 w-full rounded-[1rem] border border-slate-200 bg-slate-50 px-4 py-3 text-sm leading-6 text-slate-900 outline-none transition focus:border-slate-400"
                  onChange={(event) =>
